package me.onimula.helpers.styled;
...
public final class StyledFontRenderer implements Wrapper {
	...
	public static float getWidth(StyledFont font, String text) {
		MatrixStack matrix = new MatrixStack();
		float width = renderString(matrix, font, text, 0, 0, false, Color.WHITE);
		return width;
	}
