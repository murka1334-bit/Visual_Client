...
public class Shader implements Wrapper {
	...
	public static String getShaderSource(String fileName) {
		String source = "";
		BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(TemplateMod.class
				.getResourceAsStream("/assets/" + TemplateMod.MOD_ID + "/shaders/" + fileName)));
